...
<script>
   ...
   <div class="container first">
   	<div class="row">
   		<div class="col-md-6 float-left hidden-md-down iphone-hide"><h2>STEFE - Banská Bystrica</h2></div>
   		<div class="col-md-6 float-right">
   			<div class="container">
			<div class="dropdown show float-right stefe-dropdown">
			  <a class="btn dropdown-toggle hit-me" href="" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Banská Bystrica</a>
   ...
   <div class="container" style="padding: 0;">
   		<div class="well">
				...
				<p class="autor">Mgr. Dalibor Líška/STEFE Banská Bystrica, a. s.</p>
   		</div>
   </div>
			   ...
			   <span class="subheader">Aktuálne oznamy v: Banská Bystrica</span>
				...
				<?php
						$vypadky = $database->select("content", [
							...
							$limitForeachb = 0; //3
						  if(count($vypadky) == 0){
							  echo("<div class='col-md-12'><h3 style='color: #69BE28;'><i class='fa fa-thumbs-up' aria-hidden='true'></i> Momentálne nemáme hlásené žiadne výpadky</h3><div class='divider'></div></div>");
							  echo("<div class='col-md-12 text-right'>Nahlásiť výpadok môžete na telefónnom čísle: +421 48 XX XX XX</div>");
						  } else{
    ...
    <div class="row nopadding">
    	...
    	<div class="container-fluid" style="background: #69BE28; min-height: 40px; margin: 0; padding:0; color: white;text-align: center;">
    		<div class="container subfooter">
    			<span><a href="./informacie_bb.php">Informácie</a> | <a href="./sitemap.php">Mapa stránky</a> | <a href="www.brickstone.design" target="_blank">Web od Brickstone.design</a></span>
    		</div>
    	</div>
    </footer>
