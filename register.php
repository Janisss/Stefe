  ...
  <body>
    <?php
	  ...
	  if (isset($_POST["login"])) {
		  $postmeno = $_POST["meno"];
		  $postcelemeno = $_POST["celemeno"];
		  $postheslo1 = $_POST["heslo1"];
		  $postheslo2 = $_POST["heslo2"];
		  if($postheslo1 == $postheslo2)
		  {
			$database->insert("tabulka", [
			"meno" => $postmeno,
			"heslo" => md5($postheslo1),
			"celemeno" => $postcelemeno
			]);
      ...
      <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="post" action="register.php">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="login">Registruj</button>
            </form><!-- /form -->
